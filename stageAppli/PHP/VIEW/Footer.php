...
if (isset($page))
{
    ...
    switch ($page[1])
    {
        ...
        case "FormUtilisateur" : echo '<script src="./JS/VerifFormUtilisateur.js"></script>'."\n".
                '<script src="./JS/VerifAdresseMail.js"></script>';break;
        ...
        default : echo '<script src="./JS/Script.js"></script>';break;
